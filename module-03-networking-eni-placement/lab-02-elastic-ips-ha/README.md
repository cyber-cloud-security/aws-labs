...
## 📌 Lab Objectives
- Allocate and manage **Elastic IP (EIP)** addresses via the AWS CLI.
- Design an **Active-Passive High Availability (HA) Failover**: Automatically re-associate an Elastic IP from an unhealthy primary EC2 instance to a standby secondary EC2 instance.
- Understand AWS billing rules regarding public IPv4 addresses and idle unattached EIP penalties.
